        ...
        <div className="mobile-menu md:hidden">
            <div className="mobile-menu-bar">
                <a href="" className="flex mr-auto">
                    <img alt="Icewall Tailwind HTML Admin Template" className="w-6" src="images/logo.svg"/>
                </a>
                <a href="#!" id="mobile-menu-toggler"> <i data-feather="bar-chart-2" className="w-8 h-8 text-white transform -rotate-90"></i> </a>
            </div>
            <ul className="border-t border-theme-2 py-5 hidden">
                <li>
                    <a href="#!" className="menu">
                        <div className="menu__icon"> <i data-feather="home"></i> </div>
                        <div className="menu__title"> Dashboard <i data-feather="chevron-down" className="menu__sub-icon"></i> </div>
                    </a>
                    <ul className="">
                        <li>
                ...
                <li>
                    ...
                    <ul className="menu__sub-open">
                        <li>
                            <a href="side-menu-light-regular-form.html" className="menu menu--active">
                                <div className="menu__icon"> <i data-feather="activity"></i> </div>
