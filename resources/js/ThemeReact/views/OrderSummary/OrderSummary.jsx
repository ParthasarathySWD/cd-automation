...
function OrderSummary(props) {
  ...
  <div className="col-span-12 border-b border-gray-200">                         
    <div className="nav nav-tabs flex-col sm:flex-row justify-center lg:justify-start" role="tablist"> 
      <a data-toggle="tab" data-target="#LoanDetails" href="javascript:;" className="py-4 sm:mr-8 active" role="tab" aria-selected="true">Loan Details</a> 
      <a data-toggle="tab" data-target="#custom_tab_2" href="javascript:;" className="py-4 sm:mr-8" role="tab" aria-selected="false">Documents</a> 
      <a data-toggle="tab" data-target="#custom_tab_3" href="javascript:;" className="py-4 sm:mr-8" role="tab" aria-selected="false">Notes</a> 
      <a data-toggle="tab" data-target="#custom_tab_4" href="javascript:;" className="py-4 sm:mr-8" role="tab" aria-selected="false">History</a> 
    </div>
  </div>
  <div className="col-span-12"> 
    <div className="intro-y tab-content mt-2">
      ...
      <div id="Document" className="tab-pane" role="tabpanel">
        <div className="grid grid-cols-12 gap-3">
          <div className="col-span-12 lg:col-span-12">
