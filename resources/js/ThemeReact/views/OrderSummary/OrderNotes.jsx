                                    ...
                                    <div class="overflow-y-scroll scrollbar-hidden px-5 pt-5 flex-1">
                                        <div class="chat__box__text-box flex items-end float-left mb-4">
                                            ...
                                            <div class="bg-gray-200 dark:bg-dark-5 px-4 py-3 text-gray-700 dark:text-gray-300 rounded-r-md rounded-t-md">
                                                ...
                                                <span class="flex"><a href="" class="flex text-xs underline" style={{marginTop:"1px"}}><Icon.Paperclip className="w-3 h-3 mt-1 mr-2" />document.pdf</a></span>
                                                <div class="mt-1 text-xs text-gray-600">2 mins ago</div>
                                            </div>
                                            <div class="hidden sm:block dropdown ml-3 my-auto">
                                                <a href="javascript:;" class="dropdown-toggle w-4 h-4 text-gray-600" aria-expanded="false"> <Icon.MoreVertical className="w-5 h-5" /> </a>
                                                <div class="dropdown-menu w-40">
                                                    <div class="dropdown-menu__content box dark:bg-dark-1 p-2">
                                                        <a href="" class="flex items-center block p-2 transition duration-300 ease-in-out bg-white dark:bg-dark-1 hover:bg-gray-200 dark:hover:bg-dark-2 rounded-md"> 
                                                         <Icon.CornerUpLeft className="w-4 h-4 mr-2" />Reply </a>
                                                        <a href="" class="flex items-center block p-2 transition duration-300 ease-in-out bg-white dark:bg-dark-1 hover:bg-gray-200 dark:hover:bg-dark-2 rounded-md">
                                                         <Icon.Trash className="w-4 h-4 mr-2" />Delete </a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="chat__box__text-box flex items-end float-right mb-4">
                                            ...
                                            <div class="w-10 h-10 hidden sm:block flex-none image-fit relative ml-5">
                                                <img alt="Rubick Tailwind HTML Admin Template" class="rounded-full" src="../images/profile-3.jpg"/>
                                            </div>
                                        </div>
                                        <div class="clear-both"></div>
                                        <div class="chat__box__text-box flex items-end float-right mb-4">
                                        ...
                                        <div class="chat__box__text-box flex items-end float-left mb-4">
                                            ...
                                            <div class="bg-gray-200 dark:bg-dark-5 px-4 py-3 text-gray-700 dark:text-gray-300 rounded-r-md rounded-t-md">
                                                Angelina Jolie is typing 
                                                <span class="typing-dots ml-1"> <span>.</span> <span>.</span> <span>.</span> </span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="pt-4 sm:py-4 pb-0 flex items-center border-t border-gray-200 dark:border-dark-5">
                                        <textarea class="chat__box__input form-control dark:bg-dark-3 h-16 resize-none border-transparent px-5 py-1 shadow-none focus:ring-0" rows="1" placeholder="Type your message..."></textarea>
                                        <div class="flex absolute sm:static left-0 bottom-0 ml-5 sm:ml-0 mb-5 sm:mb-0">
                                            <div class="dropdown mr-3 sm:mr-5">
                                                <a href="javascript:;" class="dropdown-toggle w-4 h-4 sm:w-5 sm:h-5 block text-gray-600" aria-expanded="false"> <Icon.Smile className="w-full h-full" /> </a>
                                            ...
                                            <div class="w-4 h-4 sm:w-5 sm:h-5 relative text-gray-600 mr-3 sm:mr-5">
                                                 <Icon.Paperclip class="w-full h-full"/> 
                                                <input type="file" class="w-full h-full top-0 left-0 absolute opacity-0"/>
                                            </div>
                                        </div>
                                        <a href="javascript:;" class="w-8 h-8 sm:w-10 sm:h-10 block bg-theme-17 text-white rounded-full flex-none flex items-center justify-center mr-5">  <Icon.Send className="w-4 h-4" /> </a>
                                    </div>
                                </div>
