                    ...
                    <div className="intro-y box  p-5">
                        ...
                        <div className="grid grid-cols-12 gap-3">
                            <div className="col-span-6 lg:col-span-6 sm:col-span-3 mt-6"> 
                                ...
                                <input type="text" className="form-control form-control-sm" name="ClientNumber" value={state.ClientNumber} onChange={onChangeHandler} readOnly/> </div>
                            ...
                            <div className="col-span-6 lg:col-span-6 sm:col-span-6 mt-6"> 
                                ...
                                <input type="text" className="form-control form-control-sm" name="ClientName" value={state.ClientName}  onChange={onChangeHandler} readOnly/> </div>
                    ...
                    <div className="intro-y box  p-5"> 
                        ...
                        <div className="grid grid-cols-12 gap-3">
                            <div className="col-span-6 lg:col-span-6 sm:col-span-6 mt-6"> 
                                ...
                                <input type="text" className="form-control form-control-sm" name="Phone" value={state.Phone}  onChange={onChangeHandler} readOnly/> </div>
                            ...
                            <div className="col-span-6 lg:col-span-6 sm:col-span-6 mt-6"> 
                                ...
                                <input type="email" className="form-control form-control-sm" name="Email"  value={state.Email}  onChange={onChangeHandler} readOnly/> </div>
                            ...
                            <div className="col-span-6 lg:col-span-6 sm:col-span-6 mt-6"> 
                                ...
                                <input type="text" className="form-control form-control-sm" name="AddressLine1"  value={state.AddressLine1}  onChange={onChangeHandler} readOnly/> </div>
                            ...
                            <div className="col-span-6 lg:col-span-6 sm:col-span-6 mt-6"> 
                                ...
                                <input type="text" className="form-control form-control-sm" name="CityName" value={state.CityName} onChange={onChangeHandler} readOnly/> </div>
                                <span style={spanStyle}>{state.errors["CityName"]}</span>
                            </div>
                            <div className="col-span-6 lg:col-span-6 sm:col-span-6 mt-6"> 
                                <label className="form-label">County<span className="text-danger">*</span></label> 
                                <div className="input-group"> <div className="input-group-text"><Icon.MapPin className="w-4 h-4" /></div>
                                <input type="text" className="form-control form-control-sm" name="CountyName" value={state.CountyName}  onChange={onChangeHandler} readOnly/> </div>
                            </div>
                            <div className="col-span-6 lg:col-span-6 sm:col-span-6 mt-6"> 
                                <label className="form-label">State<span className="text-danger">*</span></label> 
                                <div className="input-group"> <div className="input-group-text"><Icon.Navigation className="w-4 h-4" /></div> 
                                <input type="text" className="form-control form-control-sm" name="StateName" value={state.StateName}  onChange={onChangeHandler} readOnly/> </div>
                    ...
                    <div className="intro-y box  p-5">    
                        ...
                        <div className="grid grid-cols-12 gap-3">
                            <div className="col-span-12 lg:col-span-12 sm:col-span-12 mt-6"> 
                                ...
                                <input type="text"  className="form-control form-control-sm" name="Notes"  value={state.Notes} onChange={onChangeHandler} readOnly></input>
